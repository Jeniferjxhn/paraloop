...
const completionMessage = document.getElementById("completion-message"); // Add the completion message element
...
function animate() {
  ...
  // Check if the score is 100 meters or more
  if (score >= 100) {
